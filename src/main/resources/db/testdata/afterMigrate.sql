...
INSERT INTO attendances (student_id, subject_id, date, present, note, created_at)
SELECT
    st.id, sub.id, CURRENT_DATE - i,
...
FROM student st, subjects sub, generate_series(1, 10) i;
