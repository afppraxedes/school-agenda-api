...
-- NOTA: Não há "afterMigrate" para esta tabela, pois ela é gerenciada dinamicamente pela aplicação e não deve conter dados pré-populados.
-- ============================================
...
CREATE TABLE messages (
    ...
    type VARCHAR(20) DEFAULT 'MENSAGEM',
--     read_at TIMESTAMP,
